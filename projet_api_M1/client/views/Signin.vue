  ...
  <div id="signin">
    <div class="frameP">
      <div class="header">
        <h2 class="rubrique">INSCRIPTION</h2>
      </div>
      <div class="body">
        <!-- <signinform @add-user="addUser"></signinform> -->
...
//   import FirstOfHome from './FirstOfHome.vue'
//   import LargeCard from './LargeCard.vue'
  // import LoginFormVue from './LoginForm.vue';
  // import signinform from '../components/Signinform.vue'
  
  // var signinform = httpVueLoader('../components/Signinform.vue')
  // Vue.component('signinform', signinform)
  module.exports={
    name: 'signin',
    components: {
      // /*FirstOfHome, LargeCard, LoginFormVue,*/ signinform
    },
    data(){
      return{
        user:{
  ...
  div.frameP{
    ...
    div.frame div.champ div.entry input:not(#homme, #femme), textarea{
        font-size: 100%;
        padding-left: 1%;
        width: 100%;
        height: 40px;
